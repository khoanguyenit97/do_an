...
#độ k để kiểm tra biểu thức có khả năng rút gọn nữa hay không(>0)
def k_degree(ex: BooleanFunction) -> int:
    ...
    #số phép phủ định và kéo theo trong biểu thức
    not_and_implies_count = ex.atoms(Not, Implies).__len__()
    #args: tất cả các biến trong biểu thức bao gồm 0, 1
    ...
    #args: tất cả các biến trong biểu thức, KHÔNG bao gồm 0, 1
